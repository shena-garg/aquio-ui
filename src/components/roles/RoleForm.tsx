...
const ENTITIES: EntityDef[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "product.analytics", label: "View Analytics", description: "View procurement and sales analytics charts for a product." },
      { key: "product.audit-log", label: "View Activity Log", description: "View the activity log of actions performed on a product." },
    ],
  },
  {
    entity: "partner",
    label: "Partner",
    permissions: [
      { key: "partner.view", label: "View Partner", description: "View partner companies, their users, and their locations." },
      { key: "partner.add", label: "Add Partner", description: "Add new partner companies and primary contacts." },
      { key: "partner.edit", label: "Edit Partner", description: "Edit partner company details, user access, and locations." },
    ],
  },
  {
    ...
    permissions: [
      ...
      { key: "purchase-order.audit-log", label: "View Activity Log", description: "View the activity log of actions performed on a purchase order." },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "sales-order.audit-log", label: "View Activity Log", description: "View the activity log of actions performed on a sales order." },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "auction-buy.view-bids", label: "View Bids", description: "View all bids received from partners in a buy-type auction." },
      { key: "auction-buy.reject-bid", label: "Reject Bid", description: "Reject a partner's bid in a buy-type auction." },
      { key: "auction-buy.create-counter-offer", label: "Create Counter Offer", description: "Create a counter offer in response to a partner's bid." },
      ...
      { key: "auction-buy.accept-bid", label: "Accept Bid", description: "Accept a bid submitted by a partner in a buy-type auction." },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "auction-sale.view-bids", label: "View Bids", description: "View all bids received from partners in a sell-type auction." },
      { key: "auction-sale.reject-bid", label: "Reject Bid", description: "Reject a partner's bid in a sell-type auction." },
      { key: "auction-sale.create-counter-offer", label: "Create Counter Offer", description: "Create a counter offer in response to a partner's bid." },
      ...
      { key: "auction-sale.accept-bid", label: "Accept Bid", description: "Accept a bid submitted by a partner in a sell-type auction." },
  ...
  },
  {
    ...
    label: "Notifications",
    permissions: [
      { key: "notification.view", label: "View Notifications", description: "View all notifications sent to partner users or team members." },
      { key: "notification.send", label: "Send Notifications", description: "Send custom notifications to partners or internal teams." },
    ],
  },
];
      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={`px-2.5 sm:px-3.5 py-1.5 text-[12px] sm:text-[13px] font-medium transition-colors ${
              isActive
      ...
      {state.access === "custom" && (
        <div className="divide-y divide-gray-200">
          {entityDef.permissions.map((perm) => (
            <div
              key={perm.key}
              className="flex items-center justify-between pl-4 sm:pl-8 pr-2 sm:pr-4 py-2.5"
            >
              <div className="pr-4">
    ...
    <div className="flex flex-1 flex-col">
      ...
      <div className="flex-1 overflow-auto bg-[#f9fafb]">
        <div className="mx-auto max-w-[800px] p-4 sm:p-6">
          ...
          <div className="rounded-[10px] border border-[#e5e7eb] bg-white px-3 sm:px-6 py-4 sm:py-5 mb-4 sm:mb-6">
