...
export function POQuickView({ po, onClose }: POQuickViewProps) {
  ...
  const commonUOM = getUOMAbbreviation(po.commonUOM ?? "");
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3 px-2 text-right text-[13px] text-[#111827] whitespace-nowrap">
                          ...
                          {uomAbbr && (
                            <span className="text-[11px] text-[#9ca3af] ml-0.5">{uomAbbr}</span>
                          )}
                        </td>
                          ...
                          {isForceClosed ? (
                            <div className="flex flex-col items-end">
                              <span className="text-[13px] line-through text-[#9ca3af]">
                                ...
                                {uomAbbr && (
                                  <span className="text-[11px] ml-0.5">{uomAbbr}</span>
                                )}
                              </span>
                ...
                <tfoot>
                  <tr className="border-t border-[#e5e7eb]">
                    ...
                    <td className="py-3 px-2 text-right whitespace-nowrap">
                      {hasUniformUOM && po.totalQuantity != null ? (
                        <span className="text-[13px] font-semibold text-[#111827]">
                          {(totalOrdered - totalReceived).toLocaleString("en-IN", { minimumFractionDigits: 0, maximumFractionDigits: 3 })}
                          <span className="text-[11px] text-[#9ca3af] font-normal ml-0.5">{commonUOM}</span>
                        </span>
                      ) : null}
                    </td>
